...
export default function NotificationCard({
  ...
  return (
    <div
      ...
      } ${onClick ? "cursor-pointer hover:-translate-y-0.5" : ""} ${compact ? "p-3" : "p-5"}`}
      onClick={onClick}
    >
      <div className={`flex items-start ${compact ? "gap-2.5" : "gap-3.5"}`}>
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className={`mt-0.5 ${compact ? "text-xs leading-5" : "text-sm leading-6"} text-slate-600 dark:text-white/70 line-clamp-2`}>
