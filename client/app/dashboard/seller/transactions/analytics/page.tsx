...
export default function SellerTransactionAnalyticsPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const data = await sellerAPI.getAllTransactions({ limit: 1000 }); // Increase limit to fetch all for summary if needed
