...
import SellerMobileNav from "@/app/dashboard/components/seller/SellerMobileNav";
...
function SettingsContent() {
  ...
  const handleHeaderBack = () => {
    ...
    router.push("/dashboard/seller/settings?tab=main");
  };
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white">
      <PageHeader 
        title={title} 
        subtitle={subtitle} 
        backHref={activeTab === "main" ? "/dashboard/seller" : "/dashboard/seller/settings?tab=main"}
                ...
                <button
                  ...
                  onClick={() => {
                    if (item.isExternal) {
                      ...
                      router.push(`/dashboard/seller/settings?tab=${item.id}`);
                    }
                  }}
