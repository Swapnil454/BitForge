    ...
    <div className="flex gap-2 w-full relative" ref={dropdownRef}>
      ...
      {showFilters && (
        <div className="absolute right-0 top-[110%] w-56 bg-white dark:bg-[#1a1a24] border border-slate-200 dark:border-white/10 rounded-2xl shadow-xl z-50 p-3 origin-top-right animate-in fade-in zoom-in-95 duration-200">
          ...
          {/* CATEGORY */}
          <div className="mb-3">
            <p className="text-[10px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-wider mb-1.5">Category</p>
          ...
          {/* SORT */}
          <div>
            <p className="text-[10px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-wider mb-1.5">Sort</p>
