...
export default async function TermsAndConditionsPage() {
  ...
  return (
    <main className="relative min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white overflow-x-hidden">
      {/* HEADER */}
      <DynamicHeader title="Terms & Conditions" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 pb-20 pt-16 sm:pt-20 md:pb-28">
        ...
        <section className="mb-6 rounded-2xl border border-slate-200/60 dark:border-white/10 bg-white dark:bg-white/5 p-4 sm:p-6 shadow-sm">
          ...
          <nav className="grid gap-2 text-sm text-slate-600 dark:text-white/70 sm:grid-cols-2">
            <a href="#acceptance" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">1. Acceptance of Terms</a>
            <a href="#definitions" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">2. Definitions</a>
            <a href="#accounts" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">3. User Accounts</a>
            <a href="#buyer-terms" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">4. Buyer Terms</a>
            <a href="#seller-terms" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">5. Seller Terms</a>
            <a href="#payments" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">6. Payments and Fees</a>
            <a href="#intellectual-property" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">7. Intellectual Property</a>
            <a href="#prohibited" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">8. Prohibited Activities</a>
            <a href="#content" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">9. Content Standards</a>
            <a href="#disputes" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">10. Dispute Resolution</a>
            <a href="#disclaimers" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">11. Disclaimers and Limitations</a>
            <a href="#indemnification" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">12. Indemnification</a>
            <a href="#termination" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">13. Termination</a>
            <a href="#privacy" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">14. Privacy</a>
            <a href="#changes" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">15. Changes to Terms</a>
            <a href="#governing-law" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">16. Governing Law</a>
            <a href="#contact" className="hover:text-indigo-600 dark:hover:text-cyan-300 transition-colors font-medium">17. Contact Information</a>
          </nav>
        </section>
        ...
        <div className="space-y-6 text-sm text-slate-600 dark:text-white/70">
          ...
          <section id="acceptance" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">1. Acceptance of Terms</h2>
          ...
          <section id="definitions" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">2. Definitions</h2>
            <p className="mb-3 leading-relaxed">For the purposes of these Terms:</p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;Platform&quot;</strong> refers to the BitForge
                website, applications, services, and related infrastructure.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;Seller&quot;</strong> refers to any user who lists,
                offers, or sells digital products on the Platform.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;Buyer&quot;</strong> refers to any user who browses,
                purchases, or downloads digital products from the Platform.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;Digital Product&quot;</strong> refers to any
                software, digital content, licenses, access keys, or other intangible goods offered for
                sale on the Platform.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;Content&quot;</strong> refers to any text, images,
                videos, software, data, or other materials uploaded, posted, or transmitted through the
                Platform.
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">&quot;We,&quot; &quot;Us,&quot; or &quot;BitForge&quot;</strong> refers
          ...
          <section id="accounts" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">3. User Accounts and Registration</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.1 Account Creation</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.2 Account Security</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.3 Account Types</h3>
            <p className="mb-3 leading-relaxed">
          ...
          {/* 4. Buyer Terms */}
          <section id="buyer-terms" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">4. Buyer Terms</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">4.1 Purchases</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">4.2 Payment</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">4.3 Access and Downloads</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">4.4 License and Usage Rights</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">4.5 Refunds and Returns</h3>
            <p className="mb-3 leading-relaxed">
          ...
          {/* 5. Seller Terms */}
          <section id="seller-terms" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">5. Seller Terms</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.1 Seller Eligibility</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.2 Product Listings</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.3 Pricing and Discounts</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.4 Seller Obligations</h3>
            <p className="mb-3 leading-relaxed">As a Seller, you agree to:</p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.5 Seller Payouts</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">5.6 Product Removal</h3>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="payments" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">6. Payments and Fees</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.1 Platform Fees</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.2 Taxes</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.3 Currency</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.4 Payment Disputes</h3>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="intellectual-property" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">7. Intellectual Property Rights</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">7.1 Platform Ownership</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">7.2 User Content Ownership</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">7.3 DMCA and Copyright Complaints</h3>
            <p className="mb-3 leading-relaxed">
              ...
              submit a notice to our designated copyright agent at{" "}
              <a href="mailto:legal@bittforge.in" className="font-medium text-indigo-600 dark:text-cyan-300 hover:underline">legal@bittforge.in</a> with:
            </p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
          ...
          <section id="prohibited" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">8. Prohibited Activities</h2>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="content" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">9. Content Standards and Moderation</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">9.1 User Content Responsibility</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">9.2 Prohibited Content</h3>
            <p className="mb-3 leading-relaxed">Content must not:</p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">9.3 Content Moderation</h3>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="disputes" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">10. Dispute Resolution</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">10.1 User Disputes</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">10.2 Dispute Process</h3>
            <p className="mb-3 leading-relaxed">Our dispute resolution process typically involves:</p>
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">10.3 Disputes with BitForge</h3>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="disclaimers" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">11. Disclaimers and Limitations of Liability</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">11.1 Platform &quot;As Is&quot;</h3>
            <p className="mb-3 leading-relaxed uppercase text-xs bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-xl p-4 text-amber-900 dark:text-amber-200/80 not-uppercase">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">11.2 No Warranty on Products</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">11.3 Limitation of Liability</h3>
            <p className="mb-3 leading-relaxed uppercase text-xs bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-xl p-4 text-amber-900 dark:text-amber-200/80">
              ...
              OR USE THE PLATFORM; ANY CONDUCT OR CONTENT OF ANY THIRD PARTY ON THE PLATFORM; ANY
              CONTENT OBTAINED FROM THE PLATFORM; OR UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR
              TRANSMISSIONS OR CONTENT. IN NO EVENT SHALL OUR AGGREGATE LIABILITY EXCEED THE GREATER
              OF TEN THOUSAND RUPEES (INR ₹10,000) OR THE AMOUNT YOU PAID TO BITFORGE IN THE PAST
              SIX MONTHS.
            </p>
          </section>
          ...
          <section id="indemnification" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">12. Indemnification</h2>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="termination" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">13. Account Termination and Suspension</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">13.1 Termination by You</h3>
            <p className="mb-3 leading-relaxed">
              You may terminate your account at any time by contacting our support team at{" "}
              <a href="mailto:support@bittforge.in" className="font-medium text-indigo-600 dark:text-cyan-300 hover:underline">support@bittforge.in</a>.
              Upon termination, you will no longer have access to your account, but you will retain
              access to any products you have purchased as a Buyer.
            </p>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">13.2 Termination by BitForge</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">13.3 Effect of Termination</h3>
            <p className="mb-3 leading-relaxed">Upon termination:</p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
          ...
          <section id="privacy" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">14. Privacy and Data Protection</h2>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="changes" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">15. Changes to These Terms</h2>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="governing-law" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">16. Governing Law and Jurisdiction</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">16.1 Governing Law</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">16.2 Dispute Resolution and Arbitration</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <p className="mb-3 leading-relaxed">The arbitration shall:</p>
            <ul className="ml-6 list-disc space-y-2 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">16.3 Exception for Small Claims</h3>
            <p className="mb-3 leading-relaxed">
              Either party may bring an action in small claims court if the claim qualifies and remains
              in small claims court.
            </p>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">16.4 Jurisdiction</h3>
            <p className="mb-3 leading-relaxed">
          ...
          <section id="contact" className="scroll-mt-28">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">17. Contact Information</h2>
            <p className="mb-5 leading-relaxed">
              If you have any questions, concerns, or complaints about these Terms, please contact us at:
            </p>
            <div className="rounded-2xl border border-slate-200/60 dark:border-white/10 bg-white dark:bg-white/5 p-5 sm:p-6 shadow-sm space-y-2">
              ...
              <p className="text-slate-700 dark:text-white/80 text-sm">Address: Pune, Maharashtra, India</p>
              <p className="text-slate-700 dark:text-white/80 text-sm">Business Hours: Monday - Friday, 9:00 AM - 6:00 PM IST</p>
            </div>
          </section>

          {/* Additional Provisions */}
          <section className="mt-10 border-t border-slate-200 dark:border-white/10 pt-8">
            <h2 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">Additional Provisions</h2>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Severability</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Waiver</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Assignment</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Entire Agreement</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Force Majeure</h3>
            <p className="mb-3 leading-relaxed">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Notices</h3>
            <p className="mb-3 leading-relaxed">
              We may provide notices to you via email, regular mail, or postings on the Platform.
              Notices to BitForge should be sent to{" "}
              <a href="mailto:legal@bittforge.in" className="font-medium text-indigo-600 dark:text-cyan-300 hover:underline">legal@bittforge.in</a>.
            </p>
          </section>
        </div>
