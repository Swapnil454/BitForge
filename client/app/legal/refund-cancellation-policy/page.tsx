    ...
    <main className="relative min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white overflow-x-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 pb-20 pt-24 sm:pt-28 md:pt-32 md:pb-28">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-sm text-slate-600 dark:text-white/70">
          {/* 1. Overview */}
          <section id="overview">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">1. Policy Overview</h2>
            <p className="mb-3">
            ...
            <p>
              <strong className="text-slate-800 dark:text-white/90">Important:</strong> In the event of any conflict between
          ...
          <section id="digital-nature">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">2. Nature of Digital Products</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">General Rule:</strong> All sales are final unless they meet
          ...
          <section id="refund-eligibility">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">3. Refund Eligibility Criteria</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">Action Required:</strong> You must report non-delivery issues
              within <strong>48 hours</strong> of purchase to be eligible for a full refund.
            </p>

            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.2 Material Misrepresentation</h3>
            <p className="mb-3">
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">Evidence Required:</strong> You must provide screenshots,
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.3 Technical Defects</h3>
            <p className="mb-3">
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">Note:</strong> Minor bugs, cosmetic issues, or features you
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.4 Duplicate Purchases</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">3.5 Unauthorized Purchases</h3>
            <p className="mb-3">
          ...
          <section id="non-refundable">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">4. Non-Refundable Purchases</h2>
            <p className="mb-3">
              Refunds will <strong className="text-slate-800 dark:text-white/90">NOT</strong> be issued in the following situations:
            </p>
            <ul className="ml-6 list-disc space-y-2">
              <li>
                <strong className="text-slate-800 dark:text-white/90">Change of Mind:</strong> Buyer simply changes their mind
                or no longer wants the product;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Buyer&apos;s Remorse:</strong> Product purchased impulsively
                or without reading the description;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Lack of Use:</strong> Buyer does not use or understand
                how to use the product;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Compatibility Issues (Disclosed):</strong> Product does
                not work with your system if requirements were clearly stated;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Subjective Dissatisfaction:</strong> Product does not meet
                your personal preferences or aesthetic tastes;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Found Cheaper Elsewhere:</strong> Product is available at
                a lower price on another platform;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Already Accessed/Downloaded:</strong> Product has been
                fully downloaded, opened, or license key activated (except for cases in Section 3);
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Promotional Pricing:</strong> Products purchased during
                sales or with discount codes (unless they meet eligibility criteria);
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Past Refund Window:</strong> Requests made after the
                specified timeframes in Section 3;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Violation of Terms:</strong> Purchases made in violation
                of our Terms &amp; Conditions;
              </li>
              <li>
                <strong className="text-slate-800 dark:text-white/90">Partial Refunds:</strong> We do not offer partial refunds
          ...
          <section id="refund-process">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">5. Refund Request Process</h2>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Step 2: Wait for Seller Response</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Step 3: Contact BitForge Support</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Step 4: Provide Required Information</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">Step 5: Review and Decision</h3>
            <p className="mb-3">
              BitForge will:
            </p>
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">Note:</strong> BitForge&apos;s decision is final and binding.
          ...
          <section id="refund-timeline">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">6. Refund Processing Timeline</h2>
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.2 Payment Method Timelines</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">6.3 Currency and Exchange Rates</h3>
            <p className="mb-3">
          ...
          <section id="cancellation">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">7. Order Cancellation</h2>
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">7.2 Seller-Initiated Cancellation</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">7.3 BitForge-Initiated Cancellation</h3>
            <p className="mb-3">
          ...
          <section id="seller-refunds">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">8. Seller-Initiated Refunds</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              <strong className="text-slate-800 dark:text-white/90">Note for Sellers:</strong> Refunds reduce your payout amount.
          ...
          <section id="payment-methods">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">9. Refund Payment Methods</h2>
            <p className="mb-3">
          ...
          <section id="chargebacks">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">10. Chargebacks and Payment Disputes</h2>
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">10.2 Chargeback Policy</h3>
            <p className="mb-3">
              <strong className="text-slate-800 dark:text-white/90">Please do not file a chargeback without contacting us first.</strong>
            </p>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">10.3 Exceptions</h3>
            <p className="mb-3">
          ...
          <section id="consumer-rights">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">11. Consumer Rights Under Indian Law</h2>
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">11.2 Limitations for Digital Goods</h3>
            <p className="mb-3">
            ...
            <h3 className="mb-2 mt-4 text-base font-semibold text-slate-800 dark:text-white/90">11.3 Consumer Forum Disputes</h3>
            <p className="mb-3">
          ...
          {/* 12. Contact */}
          <section id="contact">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">12. Contact Us for Refund Requests</h2>
            <p className="mb-3">
            ...
            <div className="rounded-2xl border border-white/12 bg-slate-100 dark:bg-white/5 p-5">
              ...
              <p className="mb-2 text-sm font-semibold text-slate-700 dark:text-white/80">Refund &amp; Cancellation Support:</p>
              <p className="mb-1 text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">support@bittforge.in</span></p>
              <p className="mb-1 text-slate-600 dark:text-white/70">Subject: &quot;Refund Request - Order #[Your Order Number]&quot;</p>
              
              <p className="mb-2 mt-4 text-sm font-semibold text-slate-700 dark:text-white/80">Response Time:</p>
              <p className="mb-1 text-slate-600 dark:text-white/70">Initial acknowledgment: Within 24–48 hours</p>
              <p className="mb-1 text-slate-600 dark:text-white/70">Full investigation and decision: 3–7 business days</p>
              
              <p className="mb-2 mt-4 text-sm font-semibold text-slate-700 dark:text-white/80">Payment &amp; Technical Issues:</p>
              <p className="mb-1 text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">help@bittforge.in</span></p>
          ...
          <section className="mt-10 border-t border-slate-200 dark:border-white/10 pt-8">
            <h2 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">Policy Updates and Changes</h2>
            <p className="mb-3">
