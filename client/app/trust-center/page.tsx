      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 pb-20 pt-24 sm:pt-28 md:pt-32 md:pb-28">
        ...
        <section className="mb-12 max-w-4xl">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <span className="text-xs text-white/50 border border-slate-200 dark:border-white/10 rounded-full px-3 py-1">
        ...
        <section className="mb-14 grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-emerald-400/30 bg-linear-to-b from-emerald-500/10 to-cyan-500/10 p-5">
            ...
            <h3 className="mb-2 text-base font-semibold text-slate-900 dark:text-white">Security First</h3>
          ...
          <div className="rounded-2xl border border-cyan-400/30 bg-linear-to-b from-cyan-500/10 to-indigo-500/10 p-5">
            ...
            <h3 className="mb-2 text-base font-semibold text-slate-900 dark:text-white">Privacy by Design</h3>
            <p className="text-xs text-slate-600 dark:text-white/70">
          ...
          <div className="rounded-2xl border border-indigo-400/30 bg-linear-to-b from-indigo-500/10 to-purple-500/10 p-5">
            ...
            <h3 className="mb-2 text-base font-semibold text-slate-900 dark:text-white">Regulatory Compliance</h3>
            <p className="text-xs text-slate-600 dark:text-white/70">
        ...
        {/* NAVIGATION */}
        <section className="mb-12 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/5 p-5">
          <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide text-slate-700 dark:text-white/80">
            Quick Navigation
          </h2>
        ...
        <div className="space-y-14">
          ...
          <section id="security" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Security & Infrastructure</h2>

            <div className="space-y-6">
              <div>
                <h3 className="mb-2 text-base font-semibold text-slate-800 dark:text-white/90">Application Security</h3>
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Encryption in Transit:</strong> All data transmitted
                    between your device and our servers is encrypted using TLS 1.3 with 256-bit encryption.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Encryption at Rest:</strong> Sensitive data (passwords,
                    payment details, personal information) is encrypted at rest using AES-256 encryption.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Password Security:</strong> User passwords are hashed
                    using bcrypt with salt, never stored in plain text.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Session Management:</strong> Secure session tokens with
                    automatic expiry and IP binding to prevent session hijacking.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">API Security:</strong> Rate limiting, authentication
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Cloud Hosting:</strong> Hosted on enterprise-grade
                    cloud infrastructure (AWS/Google Cloud) with SOC 2 Type II compliance.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">DDoS Protection:</strong> Multi-layer DDoS mitigation
                    to ensure platform availability during attacks.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Firewalls & Network Security:</strong> Web application
                    firewall (WAF) and intrusion detection systems (IDS) monitoring all traffic.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Database Security:</strong> Isolated database clusters
                    with access controls, regular backups, and point-in-time recovery.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Vulnerability Scanning:</strong> Automated daily scans
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Penetration Testing:</strong> Planned quarterly security
                    penetration tests conducted by independent third-party firms.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Code Reviews:</strong> Mandatory security code reviews
                    for all production deployments.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Dependency Scanning:</strong> Automated scanning of
                    open-source dependencies for known security vulnerabilities.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Bug Bounty Program:</strong> We welcome responsible
          ...
          {/* Data Privacy */}
          <section id="privacy" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Data Privacy & Protection</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Data Minimization:</strong> We collect only the data
                    necessary to provide our services.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Purpose Limitation:</strong> Data is used only for the
                    purposes disclosed at collection.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Transparency:</strong> Clear, accessible privacy notices
                    explaining our data practices.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">User Control:</strong> You can access, correct, delete,
                    or export your data at any time.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Security:</strong> Appropriate technical and
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">DPDP Act 2023 (India):</strong> Full compliance with
                    India&apos;s Digital Personal Data Protection Act, including Grievance Officer appointment
                    and user rights mechanisms.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">GDPR (EU):</strong> GDPR-compliant for European users,
                    including lawful basis documentation and data transfer safeguards.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Data Residency:</strong> Primary data storage in India;
                    cross-border transfers use standard contractual clauses.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Third-Party Vendors:</strong> All service providers
          ...
          {/* Payment Security */}
          <section id="payments" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Payment Security</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Razorpay:</strong> Primary payment gateway for India
                    (PCI DSS Level 1 compliant, RBI authorized).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Stripe:</strong> Secondary payment processor for
                    international transactions (PCI DSS Level 1 compliant).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">UPI & Net Banking:</strong> Direct bank integrations
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Real-Time Fraud Detection:</strong> Machine learning
                    models analyze transactions for suspicious patterns.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">3D Secure Authentication:</strong> Additional
                    verification layer (OTP, biometric) for card transactions.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Velocity Checks:</strong> Automated limits on
                    transaction frequency and amounts to prevent abuse.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Chargeback Monitoring:</strong> Proactive monitoring
                    and dispute management to protect buyers and sellers.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">IP & Device Fingerprinting:</strong> Detection of
          ...
          {/* Seller Verification */}
          <section id="verification" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Seller Verification & Trust</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ol className="ml-6 list-decimal space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Identity Verification:</strong> Government-issued ID
                    (Aadhaar, PAN, passport) verification via third-party KYC providers.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Business Verification:</strong> For registered
                    businesses, GST number and business registration documents are verified.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Bank Account Verification:</strong> Micro-deposit
                    verification or Aadhaar-linked bank verification.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Product Review:</strong> Initial product listings are
                    manually reviewed for compliance with content policies.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Ongoing Monitoring:</strong> Continuous monitoring of
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Automated Scanning:</strong> AI-powered content analysis
                    to detect prohibited items, malware, and policy violations.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Human Review:</strong> Dedicated moderation team reviews
                    flagged content and user reports.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Virus Scanning:</strong> All uploaded files scanned for
                    malware and viruses before being made available for download.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Intellectual Property Protection:</strong> DMCA
          ...
          {/* Compliance */}
          <section id="compliance" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Compliance & Certifications</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Digital Personal Data Protection Act (DPDP), 2023:</strong>
                    Compliance with India&apos;s primary data protection law, including Grievance Officer
                    designation and data rights management.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Information Technology Act, 2000:</strong> Adherence to
                    intermediary guidelines and digital signature requirements.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Consumer Protection Act, 2019:</strong> E-commerce
                    rules compliance, including transparent pricing and complaint redressal.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">RBI Guidelines:</strong> Compliance with payment system
                    regulations and KYC norms for financial transactions.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">GST Compliance:</strong> Automated GST calculation,
                    invoice generation, and reporting for sellers.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">GDPR (EU Residents):</strong> Lawful basis for
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">ISO 27001 (In Progress):</strong> Working towards
                    information security management system certification.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">SOC 2 Type II:</strong> Our cloud infrastructure
                    partners maintain SOC 2 Type II compliance.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">PCI DSS:</strong> Payment processors are PCI DSS Level
                    1 compliant; BitForge operates as a PCI DSS compliant merchant.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">OWASP Top 10:</strong> Security controls aligned with
          ...
          {/* Incident Response */}
          <section id="incident" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Incident Response & Business Continuity</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Detection & Analysis:</strong> 24/7 security monitoring
                    and automated alerting for anomalous activity.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Containment:</strong> Immediate isolation of affected
                    systems to prevent spread of security incidents.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Eradication & Recovery:</strong> Root cause analysis,
                    vulnerability patching, and system restoration.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Communication:</strong> Transparent notification to
                    affected users within 72 hours of confirmed data breaches (as required by DPDP Act).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Post-Incident Review:</strong> Comprehensive analysis
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">High Availability:</strong> Multi-region deployment
                    with automatic failover for 99.9% uptime.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Data Backups:</strong> Automated daily backups with
                    point-in-time recovery up to 30 days.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Geographic Redundancy:</strong> Data replicated across
                    multiple data centers in different geographic locations.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Recovery Time Objective (RTO):</strong> Target recovery
                    within 4 hours for critical services.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Recovery Point Objective (RPO):</strong> Maximum data
          ...
          {/* Transparency */}
          <section id="transparency" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Transparency & Reporting</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-xl border border-white/12 bg-slate-100 dark:bg-white/5 p-4">
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">99.9%</p>
                    <p className="mt-1 text-xs text-slate-600 dark:text-white/70">Platform Uptime (Last 90 Days)</p>
                  </div>
                  <div className="rounded-xl border border-white/12 bg-slate-100 dark:bg-white/5 p-4">
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">&lt; 72h</p>
                    <p className="mt-1 text-xs text-slate-600 dark:text-white/70">Average Incident Response Time</p>
                  </div>
                  <div className="rounded-xl border border-white/12 bg-slate-100 dark:bg-white/5 p-4">
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">100%</p>
                    <p className="mt-1 text-xs text-slate-600 dark:text-white/70">Seller KYC Verification Rate</p>
                  </div>
                  <div className="rounded-xl border border-white/12 bg-slate-100 dark:bg-white/5 p-4">
                    <p className="text-2xl font-bold text-slate-900 dark:text-white">0</p>
                    <p className="mt-1 text-xs text-slate-600 dark:text-white/70">Confirmed Data Breaches (All Time)</p>
                  </div>
                </div>
              </div>
          ...
          {/* Best Practices */}
          <section id="best-practices" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Security Best Practices for Users</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Use Strong Passwords:</strong> Create unique passwords
                    with at least 12 characters, including uppercase, lowercase, numbers, and symbols.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Enable Two-Factor Authentication (2FA):</strong> Add an
                    extra layer of security to your account (coming soon).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Verify Email Communications:</strong> Always check that
                    emails claiming to be from BitForge come from @bittforge.in addresses.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Keep Software Updated:</strong> Ensure your browser and
                    operating system are up to date with the latest security patches.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Use Secure Networks:</strong> Avoid accessing your
                    account on public Wi-Fi without a VPN.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Monitor Account Activity:</strong> Regularly review your
                    transaction history and report suspicious activity immediately.
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Log Out on Shared Devices:</strong> Always log out when
              ...
              <div className="rounded-2xl border border-amber-400/30 bg-amber-500/5 p-5">
                ...
                <ul className="ml-6 list-disc space-y-1 text-xs text-slate-600 dark:text-white/70">
          ...
          <section id="disclosure" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Responsible Security Disclosure</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-emerald-400/30 bg-emerald-500/5 p-5">
                <h3 className="mb-3 text-base font-semibold text-slate-900 dark:text-white">How to Report a Vulnerability</h3>

                <p className="mb-3 text-sm text-slate-700 dark:text-white/80">
                ...
                <ul className="ml-6 list-disc space-y-1 text-sm text-slate-600 dark:text-white/70">
              ...
              <div>
                ...
                <ul className="ml-6 list-disc space-y-2 text-sm text-slate-600 dark:text-white/70">
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Hall of Fame:</strong> Public recognition on this page
                    for responsible disclosure (with your permission).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Bounty Rewards:</strong> Monetary rewards for qualifying
                    vulnerabilities based on severity (program details coming soon).
                  </li>
                  <li>
                    <strong className="text-slate-700 dark:text-white/80">Direct Communication:</strong> Opportunity to work
          ...
          {/* Contact */}
          <section id="contact" className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Security Contact Information</h2>

            <div className="space-y-6">
              <div className="rounded-2xl border border-white/12 bg-slate-100 dark:bg-white/5 p-5">
                <p className="mb-4 font-semibold text-slate-900 dark:text-white">Security Team Contacts</p>

                <div className="space-y-4 text-sm">
                  <div>
                    <p className="mb-1 font-medium text-slate-800 dark:text-white/90">Security Vulnerabilities & Bug Reports</p>
                    <p className="text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">security@bittforge.in</span></p>
                    <p className="text-xs text-slate-500 dark:text-white/60">Use for: Vulnerability disclosure, security bugs, penetration test findings</p>
                  </div>

                  <div>
                    <p className="mb-1 font-medium text-slate-800 dark:text-white/90">Privacy & Data Protection</p>
                    <p className="text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">privacy@bittforge.in</span></p>
                    <p className="text-xs text-slate-500 dark:text-white/60">Use for: Data access requests, privacy concerns, GDPR/DPDP queries</p>
                  </div>

                  <div>
                    <p className="mb-1 font-medium text-slate-800 dark:text-white/90">Grievance Officer (DPDP Act)</p>
                    <p className="text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">grievance@bittforge.in</span></p>
                    <p className="text-xs text-slate-500 dark:text-white/60">Use for: Formal complaints, data rights escalation, regulatory concerns</p>
                  </div>

                  <div>
                    <p className="mb-1 font-medium text-slate-800 dark:text-white/90">Compliance & Legal</p>
                    <p className="text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">compliance@bittforge.in</span></p>
                    <p className="text-xs text-slate-500 dark:text-white/60">Use for: Compliance reports, legal requests, audit inquiries</p>
                  </div>

                  <div>
                    <p className="mb-1 font-medium text-slate-800 dark:text-white/90">General Support</p>
                    <p className="text-slate-600 dark:text-white/70">Email: <span className="text-cyan-300">support@bittforge.in</span></p>
                    <p className="text-xs text-slate-500 dark:text-white/60">Use for: Account issues, transaction problems, general inquiries</p>
                  </div>
                </div>
              </div>

              <div>
                <p className="mb-2 text-sm font-medium text-slate-800 dark:text-white/90">PGP Public Key (Coming Soon)</p>
                <p className="text-xs text-slate-600 dark:text-white/70">
              ...
              <div>
                <p className="mb-2 text-sm font-medium text-slate-800 dark:text-white/90">Business Address</p>
        ...
        <section className="mt-14 border-t border-slate-200 dark:border-white/10 pt-8">
          <div className="flex flex-wrap items-center justify-between gap-4 text-sm">
            ...
            <div className="flex flex-wrap gap-4 text-slate-600 dark:text-white/70">
              <Link href="/legal/terms-and-conditions" className="hover:text-slate-900 dark:hover:text-white">
                Terms &amp; Conditions
              </Link>
              <Link href="/legal/privacy-policy" className="hover:text-slate-900 dark:hover:text-white">
                Privacy Policy
              </Link>
              <Link href="/legal/refund-cancellation-policy" className="hover:text-slate-900 dark:hover:text-white">
                Refund Policy
              </Link>
