...
import { AnimatedTestimonials, CursorGlow as HeroInteractions, MagneticButton, ParallaxBackground } from "./components/DynamicInteractions";
  ...
  return (
    <main className="relative min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white overflow-x-hidden">
      ...
      <section className="relative z-10 pt-6 pb-24 text-center px-5">
        ...
        <MagneticButton className="mt-8 rounded-xl bg-gradient-to-r from-cyan-400 to-indigo-500 px-9 py-4 text-lg font-bold text-black shadow-[0_0_60px_rgba(56,189,248,0.6)]">
