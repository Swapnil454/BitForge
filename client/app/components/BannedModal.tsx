...
export default function BannedModal({ bannedReason, onClose }: BannedModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-md p-8 rounded-2xl bg-[#0a0a0f] border border-red-500/30 shadow-[0_0_60px_-15px_rgba(239,68,68,0.3)] relative overflow-hidden">
        {/* Glow effect */}
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          {bannedReason && (
            <div className="w-full p-4 rounded-xl bg-red-500/5 border border-red-500/10 mb-8 text-left">
              ...
              <p className="text-white/80 text-sm mt-1">{bannedReason}</p>
            </div>
          )}
          ...
          <div className="w-full space-y-3">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl font-semibold text-white bg-white/5 border border-white/10 hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
            >
              Submit an Appeal
            </button>
            <button
