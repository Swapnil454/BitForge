  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-[#05050a] flex items-center justify-center p-4">
        <div className="w-full max-w-lg p-8 rounded-2xl bg-white/5 border border-white/10 text-center relative overflow-hidden">
          ...
          <p className="text-white/60 mb-6 leading-relaxed">
            Thank you for reaching out. Our Trust & Safety team has received your report and will review it shortly. We will contact you at <span className="text-white font-medium">{formData.reporterEmail}</span>.
          </p>
          
          <div className="bg-black/30 border border-white/5 rounded-xl p-4 mb-8">
            <span className="text-sm text-white/40 block mb-1">Your Reference ID</span>
  ...
  return (
    <div className="min-h-screen bg-[#05050a] text-white selection:bg-cyan-500/30">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-8 sm:py-12">        {/* Form Container */}
        <div className="bg-[#0a0a0f] border border-white/10 rounded-3xl shadow-2xl p-6 sm:p-10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl focus:border-cyan-400 focus:bg-white/5 outline-none transition-all"
                  />
                </div>
                <div className="space-y-1.5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-white/70">What do you need help with? <span className="text-red-400">*</span></label>
                  ...
                  {ISSUE_TYPES.map(type => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className={`font-semibold ${formData.issueType === type.id ? 'text-cyan-400' : 'text-white'}`}>
                          {type.label}
                        </span>
              ...
              <div className="space-y-1.5 mt-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl focus:border-cyan-400 focus:bg-white/5 outline-none transition-all resize-none"
                  maxLength={2000}
                />
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold flex items-center gap-2 border-b border-white/5 pb-4">
                ...
                Supporting Evidence <span className="text-sm font-normal text-white/40 ml-2">(Optional)</span>
              </h3>
              
              <div className="space-y-4">
                <div className="relative border-2 border-dashed border-white/20 rounded-2xl p-8 hover:border-cyan-400/50 hover:bg-cyan-400/5 transition-all group">
                  <input
                    type="file"
                    multiple
                    accept="image/*,.pdf"
                  ...
                  <div className="flex flex-col items-center justify-center text-center pointer-events-none">
                    <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mb-3 group-hover:bg-cyan-400/10 transition-colors">
                      <Upload className="w-6 h-6 text-white/60 group-hover:text-cyan-400" />
                    </div>
                    <p className="font-medium text-white mb-1">Click or drag files to upload</p>
                ...
                {files.length > 0 && (
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-white/70">Attached Files ({files.length}/5)</p>
                    <div className="space-y-2">
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-xl">
                          <div className="flex items-center gap-3 overflow-hidden">
                            <div className="w-10 h-10 bg-black/40 rounded-lg flex items-center justify-center flex-shrink-0">
                              <span className="text-xs font-bold text-white/40 uppercase">{file.name.split('.').pop()}</span>
                            </div>
