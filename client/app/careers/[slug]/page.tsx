...
export default function JobDetailPage() {
  ...
  if (loading) {
    return (
      <main className="relative min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white">
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-slate-500 dark:text-white/60">Loading job details...</div>
        </div>
      </main>
    );
  }
    ...
    <main className="relative min-h-screen bg-slate-50 dark:bg-[#05050a] text-slate-900 dark:text-white overflow-x-hidden">
      ...
      <div className="relative -mt-8 z-10 mx-auto max-w-5xl px-5 pb-12 pt-20 sm:pt-24 md:pt-28">
        ...
        <div className="mb-4 flex items-center gap-2 text-sm text-slate-500 dark:text-white/60">
          ...
          <span>›</span>
          <span className="text-slate-900 dark:text-white">{career.title}</span>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-white/70 text-base mb-4 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3 mb-4 text-sm text-slate-700 dark:text-white/80">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-800 dark:text-white/90 text-base leading-relaxed whitespace-pre-wrap">
              {career.description}
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-700 dark:text-white/80 text-base leading-relaxed mb-2">
