  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Webhook Payload */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Webhook Payload Structure</h2>
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <p className="text-slate-600 dark:text-white/70 mb-4">All webhook events follow this structure:</p>
            <CodeBlock
              code={`{
  "id": "evt_1234567890",
   ...
   "currency": "usd",
    ...
    "product": {
      ...
      "seller_id": "sel_def456"
          ...
          <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <ol className="space-y-4 text-slate-700 dark:text-white/80">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p>Go to <strong className="text-slate-900 dark:text-white">Dashboard → API Settings → Webhooks</strong></p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-cyan-500/20 rounded-full text-cyan-400 text-sm font-bold">
                ...
                <div>
                  <p>Click <strong className="text-slate-900 dark:text-white">Create Webhook Endpoint</strong></p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-cyan-500/20 rounded-full text-cyan-400 text-sm font-bold">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-white/60 mt-2">Example: https://yourapp.com/api/webhooks</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-cyan-500/20 rounded-full text-cyan-400 text-sm font-bold">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p>Save your <strong className="text-slate-900 dark:text-white">Signing Secret</strong> - you'll need this to verify webhooks</p>
                </div>
              </li>
            </ol>
          </div>
        ...
        {/* Verify Signature */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Verify Webhook Signature</h2>
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <p className="text-slate-600 dark:text-white/70 mb-4">
              Always verify webhook signatures to ensure requests come from Bitforge:
            </p>
            <CodeBlock
...
npm install -g @Bitforge/cli

# Forward webhooks to local development server
Bitforge webhooks listen --forward-to http://localhost:3000/api/webhooks

# Send test webhook
Bitforge webhooks test --event payment.completed`}
              language="bash"
            />
