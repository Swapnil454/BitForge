  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <nav className="mb-6 flex items-center gap-2 text-sm text-slate-500 dark:text-white/60">
        ...
        <span>/</span>
        <span className="text-slate-900 dark:text-white">API Keys Setup</span>
      </nav>
      ...
      <div className="prose prose-invert max-w-none space-y-12">
        {/* Razorpay Setup */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Razorpay Payment Gateway</h2>
          <p className="mb-4 text-slate-600 dark:text-white/70">
            Razorpay handles all payment processing for buyer purchases.
          </p>

          <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">Step 1: Create Razorpay Account</h3>
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 2: Get API Keys</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 3: Add to Environment Variables</h3>
          <p className="mb-3 text-sm text-slate-500 dark:text-white/60">Add to <code>server/.env</code>:</p>
          <CodeBlock
...
Name: Test User`}
        ...
        {/* RazorpayX Payouts */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">RazorpayX Payout System</h2>
          <p className="mb-4 text-slate-600 dark:text-white/70">
            RazorpayX enables automated bank transfers for seller payouts.
          </p>

          <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">Step 1: Activate RazorpayX</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 2: Get RazorpayX Credentials</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 3: Configure Environment</h3>
          <p className="mb-3 text-sm text-slate-500 dark:text-white/60">Add to <code>server/.env</code>:</p>
          <CodeBlock
...
RAZORPAYX_KEY_SECRET=your_razorpayx_secret`}
        ...
        {/* Google OAuth */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Google OAuth Setup</h2>
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 2: Create OAuth Credentials</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 3: Configure OAuth</h3>
          <p className="mb-3 text-sm text-slate-500 dark:text-white/60">Add to <code>server/.env</code>:</p>
          <CodeBlock
            code={`# Google OAuth
...
GOOGLE_REDIRECT_URI=http://localhost:5000/auth/google/callback`}
        ...
        {/* GitHub OAuth */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">GitHub OAuth Setup</h2>

          <h3 className="mb-3 text-lg font-semibold text-slate-900 dark:text-white">Step 1: Create OAuth App</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 2: Get Credentials</h3>
          <ol className="space-y-3 text-slate-600 dark:text-white/70">
          ...
          <h3 className="mb-3 mt-6 text-lg font-semibold text-slate-900 dark:text-white">Step 3: Update Environment</h3>
          <p className="mb-3 text-sm text-slate-500 dark:text-white/60">Add to <code>server/.env</code>:</p>
          <CodeBlock
            code={`# GitHub OAuth
...
GITHUB_REDIRECT_URI=http://localhost:5000/auth/github/callback`}
        ...
        {/* Resend Email */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Resend Email (Optional)</h2>
          <p className="mb-4 text-slate-600 dark:text-white/70">
...
RESEND_FROM_EMAIL='BitForge <no-reply@bittforge.in>'`}
        ...
        {/* Verification */}
        <section>
          <h2 className="mb-4 text-2xl font-semibold text-slate-900 dark:text-white">Verify Configuration</h2>
          <p className="mb-4 text-slate-600 dark:text-white/70">
