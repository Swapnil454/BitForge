...
export default function AuthenticationAPIPage() {
    ...
    <div className="py-10 px-4 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="mb-6 text-sm text-slate-500 dark:text-white/60">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-900 dark:text-white">Authentication API</span>
        </nav>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600 dark:text-white/70">
            Complete API reference for user authentication, registration, OAuth flows, and session management in Bitforge.
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Authentication Methods</h2>
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5 text-center">
              ...
              <h3 className="text-slate-900 dark:text-white font-semibold">JWT Tokens</h3>
  ...
  "error": "Invalid email or password"
        ...
        <section className="mb-10">
          ...
          <div className="bg-indigo-50/50 dark:bg-gradient-to-r dark:from-indigo-500/10 dark:to-cyan-500/10 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold mb-3 mt-6">Example Request</h3>
            <CodeBlock
  ...
  "error": "Invalid or expired token"
        ...
        <section className="mb-10">
          ...
          <div className="bg-indigo-50/50 dark:bg-gradient-to-r dark:from-indigo-500/10 dark:to-cyan-500/10 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            ...
            <p className="text-slate-500 dark:text-white/60 text-sm mb-4">Redirect user to this endpoint to start Google login:</p>
            <CodeBlock code="window.location.href = 'http://localhost:5000/api/auth/google';" language="javascript" />

            <h3 className="text-slate-900 dark:text-white font-semibold mb-3 mt-6">Flow</h3>
        ...
        <section className="mb-10">
          ...
          <div className="bg-indigo-50/50 dark:bg-gradient-to-r dark:from-indigo-500/10 dark:to-cyan-500/10 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold mb-3">Usage</h3>
            <p className="text-slate-500 dark:text-white/60 text-sm mb-4">Redirect user to this endpoint to start GitHub login:</p>
    ...
    "expiresIn": "7d"
        ...
        <section className="mb-10">
          ...
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold mb-3">Token Payload</h3>
            <CodeBlock
              code={`{
  ...
  "exp": 1705920600
            ...
            <h3 className="text-slate-900 dark:text-white font-semibold mb-3 mt-6">Using Tokens</h3>
            <p className="text-slate-500 dark:text-white/60 text-sm mb-3">Include the JWT in the Authorization header of protected API requests:</p>
            <CodeBlock code="Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..." language="bash" />
        ...
        {/* Error Codes */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Common Error Codes</h2>
          <div className="space-y-4">
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-white/60 text-sm">Invalid input data or missing required fields</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-1">Unauthorized</h3>
                  <p className="text-slate-500 dark:text-white/60 text-sm">Invalid credentials or missing/expired token</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-white/60 text-sm">Insufficient permissions for requested resource</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-1">Validation Error</h3>
                  <p className="text-slate-500 dark:text-white/60 text-sm">Request data failed validation rules</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-white/60 text-sm">Unexpected server error occurred</p>
                </div>
              </div>
            </div>
          </div>
