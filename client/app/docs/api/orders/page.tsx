...
export default function OrdersAPIPage() {
    ...
    <div className="py-10 px-4 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">Orders API</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <p className="text-slate-700 dark:text-white/80 mb-4">All order endpoints require authentication:</p>
  ...
  "data": {
    ...
    "purchasedAt": "2026-02-05T10:30:00.000Z"
        ...
        {/* Order Status Codes */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Order Status Codes</h2>
          <div className="space-y-3">
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              ...
              <p className="text-slate-500 dark:text-white/60 text-sm">Payment successful, product accessible for download</p>
            </div>
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                <h3 className="text-slate-900 dark:text-white font-semibold">pending</h3>
              </div>
              <p className="text-slate-500 dark:text-white/60 text-sm">Payment initiated but not yet confirmed</p>
            </div>
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-slate-500 dark:text-white/60 text-sm">Payment failed or declined</p>
            </div>
          </div>
        </section>
