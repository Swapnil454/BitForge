    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">Analytics Dashboard</h1>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Platform Analytics</h2>
          <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-xl p-6">
            <p className="text-slate-700 dark:text-white/80 mb-4">Monitor platform health, revenue, user growth, and marketplace trends.</p>
            <div className="grid md:grid-cols-4 gap-3">
              <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-lg">
                ...
                <p className="text-slate-900 dark:text-white font-semibold">Revenue</p>
                <p className="text-slate-500 dark:text-white/60 text-sm">Platform earnings</p>
              </div>
              <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-lg">
                <Users className="w-5 h-5 mx-auto mb-2 text-blue-400" />
                <p className="text-slate-900 dark:text-white font-semibold">Users</p>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Key Metrics</h2>
          <div className="space-y-4">
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <h3 className="text-slate-900 dark:text-white font-semibold mb-2"> Revenue Metrics</h3>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <h3 className="text-slate-900 dark:text-white font-semibold mb-2"> User Metrics</h3>
              <ul className="space-y-1 text-slate-600 dark:text-white/70 text-sm list-disc list-inside">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Reports & Exports</h2>
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <p className="text-slate-700 dark:text-white/80 mb-4">Generate reports for analysis:</p>
