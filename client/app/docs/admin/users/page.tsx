    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">User Management</h1>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">User Management Overview</h2>
          <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/30 rounded-xl p-6">
            <p className="text-slate-700 dark:text-white/80 mb-4">Manage user accounts, roles, permissions, and handle account-related issues.</p>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-lg text-center">
                <p className="text-slate-900 dark:text-white font-semibold">Buyers</p>
                <p className="text-slate-500 dark:text-white/60 text-sm">Purchase products</p>
              </div>
              <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-lg text-center">
                <p className="text-slate-900 dark:text-white font-semibold">Sellers</p>
                <p className="text-slate-500 dark:text-white/60 text-sm">Create & sell products</p>
              </div>
              <div className="bg-slate-100 dark:bg-white/5 p-4 rounded-lg text-center">
                <p className="text-slate-900 dark:text-white font-semibold">Admins</p>
                <p className="text-slate-500 dark:text-white/60 text-sm">Platform management</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <h3 className="text-slate-900 dark:text-white font-semibold mb-2 flex items-center gap-2"><Trash2 className="w-4 h-4" /> Delete Account</h3>
            ...
            <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-5">
              <h3 className="text-slate-900 dark:text-white font-semibold mb-2"> Verify Account</h3>
              <p className="text-slate-600 dark:text-white/70 text-sm">Manually verify seller account if automated verification fails.</p>
            </div>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Role Management</h2>
          <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <p className="text-slate-700 dark:text-white/80 mb-4">Assign and modify user roles:</p>
            <div className="space-y-3 text-slate-600 dark:text-white/70 text-sm">
